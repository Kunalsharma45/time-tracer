...
const WorkPatternAnalysisSchema = new mongoose.Schema({
    ...
    personalizedRecommendations: [{
        recommendationType: {
            type: String,
            enum: ['schedule_optimization', 'focus_improvement', 'task_planning', 'habit_formation']
        },
        title: String,
        description: String,
...
const WorkPatternAnalysis = mongoose.model('WorkPatternAnalysis', WorkPatternAnalysisSchema);
